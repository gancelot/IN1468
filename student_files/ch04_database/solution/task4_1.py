"""
      task4_1.py   -   Python Database API 2.0

      Reads data from school.db by providing a get_location() function and a partial
      or full name of a school.

      Data returned from the search of the database returns name, city, and state
