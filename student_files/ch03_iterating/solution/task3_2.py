"""
      ...
      task3_2.py   -   Using Generators and Dictionary Comprehensions

      This exercise is a refactoring of the task3_1.py solution.  It
...
def country_generator() -> Generator[str, None, None]:
