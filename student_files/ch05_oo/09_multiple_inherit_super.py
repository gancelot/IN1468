"""
    ...
    09_multiple_inherit_super.py
    This approach is hacky and requires access to the parent classes.
    It is usually not preferred over the explicit __init__() call approach.
