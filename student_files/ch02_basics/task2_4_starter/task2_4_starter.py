"""
    ...
    This file merely represents the solution from the previous task, task2_3_starter.py.
    It will run currently, as is.
...
def search(term):
    results = [city for city in cities if term.casefold() in city.name.casefold()]
