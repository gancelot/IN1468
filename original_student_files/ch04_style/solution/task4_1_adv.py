"""
      task4_1_adv.py   -   Documentation

      This solution works with city_search.py in this folder.
      See city_search_adv.py for the documentation and annotations used in this task.


"""
from pathlib import Path

import ch04_style.solution.city_search_adv as cs
